# Contributing to MindGame

## Create an issue

- If you've encountered a bug, open a [Bug Report](https://github.com/PoCInnovation/MindGame/issues/new?assignees=&labels=&template=bug_report.md&title=).
- If you want MindGame to have a new fonctionality, open a [Feature Request](https://github.com/PoCInnovation/MindGame/issues/new?assignees=&labels=&template=feature_request.md&title=).

## Resolve an issue

Select an [issue](https://github.com/PoCInnovation/MindGame/issues) that you want to resolve.

The recommended workflow is to fork this repository and open pull requests from your fork.

### 1. Fork, clone & configure MindGame upstream
...
# Create a new pull request from https://github.com/PoCInnovation/MindGame/pulls
```
